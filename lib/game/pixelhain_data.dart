...
List<PuzzleDefinition> createPixelhainPuzzles() => [
  ...
  _puzzle('snare', 'Puzzle 2 – Snare / Clap', 1, const [
    'square',
    'circle',
  ], const [
  ...
  _puzzle('bass', 'Puzzle 3 – Bassline', 2, const [
    'a',
    'b',
    'c',
  ], const [
  ...
  _puzzle('arp', 'Puzzle 4 – Arpeggio', 3, const [
    'a',
    'b',
  ], const [
  ...
  _puzzle('lead', 'Puzzle 5 – Lead-Melodie', 4, const [
    'hook',
  ], const [
    PuzzleNode(id: 'start', type: NodeType.start, position: GridPoint(0, 0)),
    PuzzleNode(
  ...
  _puzzle('finale', 'Puzzle 6 – Finale-Layer', 5, const [
    'fx',
    'counter',
  ], const [
    PuzzleNode(id: 'start', type: NodeType.start, position: GridPoint(0, 2)),
